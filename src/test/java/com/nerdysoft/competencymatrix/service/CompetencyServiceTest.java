...
class CompetencyServiceTest {
    ...
    void updateCompetency() {
        ...
        Competency updateCompetency = service.updateCompetency(ID, new Competency(ID, "testNameUPD", "testDesc", List.of()));
    ...
    void addCategoryToCompetency() {
        ...
        service.addCategoryToCompetency(1L, 2L);
    ...
    void removeCategoryFromCompetency() {
        ...
        service.removeCategoryFromCompetency(1L, 2L);
